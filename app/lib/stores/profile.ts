...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('white_label_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('white_label_profile', JSON.stringify(profileStore.get()));
  }
};
