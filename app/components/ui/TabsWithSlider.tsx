        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-wl-elements-background-depth-2 dark:bg-wl-elements-background-depth-3 text-wl-elements-textPrimary dark:text-wl-elements-textPrimary-dark hover:bg-wl-elements-background-depth-3 dark:hover:bg-wl-elements-background-depth-4 border border-wl-elements-borderColor dark:border-wl-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
