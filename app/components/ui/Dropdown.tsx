...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-wl-elements-textPrimary hover:text-wl-elements-textPrimary',
...
export const DropdownSeparator = () => <DropdownMenu.Separator className="h-px bg-wl-elements-borderColor my-1" />;
