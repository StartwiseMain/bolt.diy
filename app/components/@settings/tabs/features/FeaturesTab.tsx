      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-wl-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-wl-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-wl-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-wl-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
  ...
  ({
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-lg font-medium text-wl-elements-textPrimary">{title}</h3>
          <p className="text-sm text-wl-elements-textSecondary">{description}</p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-4">
          <div
            className={classNames(
              ...
              'bg-wl-elements-background-depth-3 group-hover:bg-wl-elements-background-depth-4',
              'transition-colors duration-200',
              'text-blue-500',
            )}
          >
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-wl-elements-textPrimary group-hover:text-blue-500 transition-colors">
              Prompt Library
            </h4>
            <p className="text-xs text-wl-elements-textSecondary mt-0.5">
          ...
          <select
            ...
            className={classNames(
              ...
              'bg-wl-elements-background-depth-3 border border-wl-elements-borderColor',
