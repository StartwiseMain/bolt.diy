    ...
    <motion.div
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-wl-elements-background-depth-2 dark:bg-wl-elements-background-depth-3 text-wl-elements-textSecondary dark:text-wl-elements-textSecondary-dark border border-wl-elements-borderColor dark:border-wl-elements-borderColor-dark',
        onRemove && 'pr-1',
        className,
      )}
    >
      ...
      {onRemove && (
        <button
          ...
          onClick={onRemove}
          className={classNames(
            'ml-1 p-0.5 rounded-full hover:bg-wl-elements-background-depth-3 dark:hover:bg-wl-elements-background-depth-4 transition-colors',
            active
