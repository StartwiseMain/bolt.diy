...
export class WorkbenchStore {
  ...
  get whiteLabelTerminal() {
    return this.#terminalStore.whiteLabelTerminal;
  }
  get alert() {
  ...
  attachWhiteLabelTerminal(terminal: ITerminal) {
    this.#terminalStore.attachWhiteLabelTerminal(terminal);
  }
