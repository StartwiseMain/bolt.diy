      ...
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            ...
            <div className="i-wl:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-wl-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-wl-elements-icon-error">{error}</p>}</div>
              </div>
