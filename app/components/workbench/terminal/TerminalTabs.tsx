...
export const TerminalTabs = memo(() => {
  ...
  const closeTerminal = useCallback(
    (index: number) => {
      if (index === 0) {
        return;
      } // Can't close White Label terminal
  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-wl-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-wl-elements-background-depth-2 border-y border-wl-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-wl-elements-terminals-buttonBackground text-wl-elements-textSecondary hover:text-wl-elements-textPrimary':
                            isActive,
                          'bg-wl-elements-background-depth-2 text-wl-elements-textSecondary hover:bg-wl-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-wl-elements-terminals-buttonBackground text-wl-elements-textPrimary': isActive,
                            'bg-wl-elements-background-depth-2 text-wl-elements-textSecondary hover:bg-wl-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-wl-elements-textTertiary hover:text-wl-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachWhiteLabelTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting White Label terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachWhiteLabelTerminal(terminal)}
