  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-wl-elements-borderColor bg-wl-elements-background-depth-1 text-wl-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-wl-elements-textSecondary', className)} {...props} />;
  },
);
