...
export type WhiteLabelAction = FileAction | ShellAction | StartAction | BuildAction | SupabaseAction;

export type WhiteLabelActionData = WhiteLabelAction | BaseAction;
