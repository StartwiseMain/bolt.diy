...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-wl-elements-background-depth-1 overflow-hidden rounded-full p-1">
    ...
    <button
      ...
      className={classNames(
        ...
        selected
          ...
          : 'text-wl-elements-item-contentDefault hover:text-wl-elements-item-contentActive',
      )}
    >
      ...
      {selected && (
        <motion.span
          ...
          className="absolute inset-0 z-0 bg-wl-elements-item-backgroundAccent rounded-full"
        ></motion.span>
      )}
    </button>
  );
