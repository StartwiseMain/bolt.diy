  ...
  return (tree: any) => {
    visit(tree, (node: any) => {
      if (node.type === 'html' && node.value && node.value.startsWith('<think>')) {
        ...
        node.value = `<div class="__whiteLabelThought__">${cleanedContent}`;
...
const rehypeSanitizeOptions: RehypeSanitizeOptions = {
  ...
  attributes: {
    ...
    div: [
      ...
      [
        'className',
        '__whiteLabelArtifact__',
        '__whiteLabelThought__',
        '__whiteLabelQuickAction__',
        '__whiteLabelSelectedElement__',
      ],

      // ['className', '__whiteLabelThought__']
    ],
    button: [
      ...
      'name',
      'value',
      ['className', '__whiteLabelArtifact__', '__whiteLabelThought__', '__whiteLabelQuickAction__'],
    ],
  },
  strip: [],
};
